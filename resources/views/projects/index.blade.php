            ...
            <a href="{{ $project->url ?? '#' }}" target="_blank" class="group block bg-slate-800/50 rounded-xl overflow-hidden border border-slate-800 hover:border-primary/50 transition-all hover:-translate-y-1">
                ...
                <div class="p-6">
                    ...
                    @if($project->github_url)
                        <a href="{{$project->github_url}}" target="_blank" class="inline-block mt-2 px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-lg border border-slate-600 hover:border-primary/50 transition-all">
